...
7. Pregunta si la instalación es para un PC físico o una máquina virtual
8. En PC físico ejecuta las pruebas de captura/reproducción y activa el relay automáticamente
